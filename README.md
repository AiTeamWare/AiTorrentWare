...
Better buy a vps 😐 and follow [this](https://github.com/TMAdminz/AiTorrentWare#process-to-run-this-bot-on-vps)

### The Legacy Way
Simply clone the repository and run the main file:

```sh
git clone https://github.com/TMAdminz/AiTorrentWare.git
cd PublicLeech
python3 -m venv venv
. ./venv/bin/activate
